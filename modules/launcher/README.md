...
| <a name="input_ecs_cluster"></a> [ecs_cluster](#input_ecs_cluster) | Name of the ECS Cluster that the service is in | `string` | n/a | yes |
| <a name="input_ecs_service"></a> [ecs_service](#input_ecs_service) | Name of the ECS service to update the desired count for | `string` | n/a | yes |
