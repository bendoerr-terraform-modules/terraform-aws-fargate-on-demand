module github.com/bendoerr-terraform-modules/terraform-aws-fargate-on-demand/modules/notice-parameter-store/test
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/iam v1.61.1 // indirect
